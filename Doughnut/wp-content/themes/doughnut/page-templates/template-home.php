          ...
          <div class="container shop-section">
            ...
            <div class="row shop-flavor-row1">
              <div class="col-sm-4">
                ...
                <?php 
                    ...
                    echo '<input type="text" value="'.$pro->get_title();''" class="patis-hidden-price" >';
                    echo '<input type="text" value="" class="patis-hidden-total" >';
              ...
              <div class="col-sm-4">
                ...
                <?php 
                    ...
                    echo '<input type="text" value="" class="cotabato-hidden-url" >';
              ...
              <div class="col-sm-4">
                ...
                <?php 
                    ...
                    echo '<input type="text" value="" class="calamansi-hidden-url" >';
            ...
            <div class="col-sm-4">
                ...
                <?php 
                    ...
                    echo '<input type="text" value="" class="meringue-hidden-url" >';
              ...
              <div class="col-sm-4">
                ...
                <?php 
                    ...
                    echo '<input type="text" value="" class="ube-hidden-url" >';
              ...
              <div class="col-sm-4">
                ...
                <?php 
                    ...
                    echo '<input type="text" value="" class="butternut-hidden-url" >';
